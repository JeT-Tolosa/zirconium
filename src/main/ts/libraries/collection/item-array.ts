...
export type ItemArrayEvents<T = unknown> = {
  ITEM_ARRAY_CHANGED: {
...
export type ItemArrayEventRegistry = MergeItemCollectionRegistries<
  ItemCollectionEventRegistry,
  {
    incoming: {};
    outgoing: PickEvents<
...
// >;
export interface ItemArrayDescriptor extends ItemCollectionDescriptor {}

export class ItemArray<T> extends ItemCollection<T, ItemArrayEventRegistry> {
  private _items: T[] = [];
   ...
   */
  constructor(descriptor: ItemArrayDescriptor) {
    super(descriptor);
  }
