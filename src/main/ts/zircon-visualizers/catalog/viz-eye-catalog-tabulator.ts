...
> extends ZirconViz<R> {
  public static VIZ_COLLECTION_CATALOG_TABULATOR_TYPE =
    'viz-collection-catalog-tabulator-type';
  ...
  public override getType(): string {
    return VizCollectionCatalogTabulator.VIZ_COLLECTION_CATALOG_TABULATOR_TYPE;
  }
  ...
  private onCATALOG_ENGINE_COLLECTION_DESCRIPTORS(
    ...
    if (catalogDescriptor?.dataType !== this.getElementsType()) {
      return;
    }
  ...
  public getCollectionCatalogComponent(): CollectionCatalogSelectorComponent {
    if (this._itemCollectionSelector) {
