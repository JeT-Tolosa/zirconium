...
import {
  AuthService,
  KeycloakAuthService,
} from '../../zirconium/zircon-user/connect-keycloak';
import { UserConnectUI } from '../../zirconium/zircon-user/connect-ui';
...
export class UserConnectUIZirconPlugin extends ZirconPlugin {
  ...
  private __connectUI: UserConnectUI = null;
  ...
  private getConnectUI(): UserConnectUI {
    if (this.__connectUI) return this.__connectUI;
    this.__connectUI = new UserConnectUI(this.__auth);
