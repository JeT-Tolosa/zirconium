import { ItemLoader } from '../../collection/item-loader';
...
export class SatelliteLocalFileLoaderCelestrakJson extends ItemLoader<Satellite> {
...
export class SatelliteHTTPSLoaderCelestrakJson extends ItemLoader<Satellite> {
